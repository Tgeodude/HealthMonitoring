...
class HealthConnectManager(private val context: Context) {
    ...
    private val _availability = MutableLiveData(SDK_UNAVAILABLE)
    var availability: LiveData<Int> = _availability
     ...
     */
    suspend fun writeExerciseSession(start: ZonedDateTime, end: ZonedDateTime, stepsCount: Long, distance: Length, energy: Energy,
        ...
        return healthConnectClient.insertRecords(
            listOf(
                ExerciseSessionRecord(
                    ...
                    title = "Моя прогулка #${Random.nextInt(0, 60)}"
                ),
                StepsRecord(
                    startTime = start.toInstant(),
                    startZoneOffset = start.offset,
